...
<template:base>
    ...
    <jsp:attribute name="menu">
        ...
        <div class="menuitem">
            <a href="<c:url value="/app/editUser/"/>">Benutzer bearbeiten</a>
        </div>
    </jsp:attribute>
                ...
                <table>
                    ...
                    <c:forEach items="${tasks}" var="task">
                        <tr>
                            ...
                            <td>
                                <c:out value="${task.art.getDisplayName()}"/>
                            </td>
                            <td>
                                <c:out value="${task.price}"/>
                            </td>
                            <td>
                                <c:out value="${task.preisArt.getDisplayName()}"/>
                            </td>
                            <td>
